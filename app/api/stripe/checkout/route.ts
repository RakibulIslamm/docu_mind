 ...
 *
 * Creates a Stripe Checkout Session for the DocuMind Pro subscription and
 * 303-redirects the browser to Stripe's hosted checkout page. Submitted from
 * `<form method="POST" action="/api/stripe/checkout">` — no client-side fetch
 * plumbing.
 */
