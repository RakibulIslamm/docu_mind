 ...
 * the Stripe test card numbers on the billing page so visitors can drive the
 * upgrade flow without entering a real card. Stripe encodes the mode in the
 * key prefix: `sk_test_…` → sandbox, `sk_live_…` → real. Auto-disappears
 * when the operator swaps to a live key.
 */
